    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            ...
            min-height: 100vh;
            background: linear-gradient(135deg, #e8f0fe 0%, #f0f4f8 50%, #e0ecf8 100%);
        ...
        .shape-2 { width: 400px; height: 400px; background: #2d5a8e; bottom: -15%; right: -10%; animation-delay: -7s; }
        .shape-3 { width: 300px; height: 300px; background: #06b6d4; top: 50%; left: 60%; animation-delay: -14s; }
        ...
        @keyframes logoPulse {
            0%, 100% { box-shadow: 0 8px 24px rgba(30, 58, 95, 0.25); }
            50% { box-shadow: 0 8px 32px rgba(30, 58, 95, 0.35); }
        }

        .login-header h1 {
            font-size: 26px; font-weight: 800;
            color: #1e293b; letter-spacing: -0.8px;
        }
        ...
        .form-input:focus + i, .form-input:focus ~ i { color: #1e3a5f; }
